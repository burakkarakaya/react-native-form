...
*/
export const ICONS = {
  addressNoResult: require("../assets/addressNoResult.png"),
  cartNoResult: require("../assets/cartNoResult.png"),
  contentNoResult: require("../assets/contentNoResult.png"),
  couponNoResult: require('../assets/couponNoResult.png'),
  favoriteNoResult: require('../assets/favoriteNoResult.png'),
  followListNoResult: require('../assets/followListNoResult.png'),
  plus: require('../assets/plus.png'),
  closedIco: require('../assets/closedIco.png'),
